...
flags.DEFINE_float("eval_bound", 0.99, "Evaluation bound for training process termination.")
...
def main(_):
  ...
  if FLAGS.do_eval:
    do_eval(processor=processor, tokenizer=tokenizer, label_list=label_list, estimator=estimator)
